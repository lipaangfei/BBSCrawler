...
for discuss_post in discuss_posts:
    ...
    try:
        ...
        # print(author, date < datetime.datetime.strptime("2020-05-01 00:00:00", "%Y-%m-%d %H:%M:%S"))
        if 'title="精华' in str(discuss_post):
            print('title="精华' in str(discuss_post))
    except:
        continue
#
#
# if __name__ == '__main__':
#     html = """<em>[<a href="https://bbs.yingjiesheng.com/forum.php?mod=forumdisplay&amp;fid=456&amp;filter=typeid&amp;typeid=594">面试</a>]</em> <a class="xst" href="https://bbs.yingjiesheng.com/forum.php?mod=viewthread&amp;tid=2318699&amp;extra=page%3D1%26filter%3Dtypeid%26typeid%3D594%26orderby%3Ddateline%250A" onclick="atarget(this)">deal advisory M面+Par面</a>
# <img align="absmiddle" alt="digest" src="https://bbsimg.yingjiesheng.net/static/image/common/digest_1.gif" title="精华 1"/>"""
#     print("精华" in html)